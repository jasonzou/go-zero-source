...
import (
	...
	"github.com/zeromicro/go-zero/tools/goctl/openapi/apigen"
	"github.com/zeromicro/go-zero/tools/goctl/openapi/dartgen"
	"github.com/zeromicro/go-zero/tools/goctl/openapi/docgen"
	"github.com/zeromicro/go-zero/tools/goctl/openapi/format"
	"github.com/zeromicro/go-zero/tools/goctl/openapi/gogen"
	"github.com/zeromicro/go-zero/tools/goctl/openapi/javagen"
	"github.com/zeromicro/go-zero/tools/goctl/openapi/ktgen"
	"github.com/zeromicro/go-zero/tools/goctl/openapi/new"
	"github.com/zeromicro/go-zero/tools/goctl/openapi/tsgen"
	"github.com/zeromicro/go-zero/tools/goctl/openapi/validate"
...
var (
	...
	Cmd = &cobra.Command{
		Use:   "openapi",
		Short: "Generate openapi related files",
...
func init() {
	...
	dartCmd.Flags().StringVar(&dartgen.VarStringAPI, "openapi", "", "The api file")
	...
	goCmd.Flags().StringVar(&gogen.VarStringAPI, "openapi", "", "The api file")
	...
	javaCmd.Flags().StringVar(&javagen.VarStringAPI, "openapi", "", "The api file")

	ktCmd.Flags().StringVar(&ktgen.VarStringDir, "dir", "", "The target dir")
	ktCmd.Flags().StringVar(&ktgen.VarStringAPI, "openapi", "", "The api file")
	...
	pluginCmd.Flags().StringVar(&plugin.VarStringAPI, "openapi", "", "The api file")
	...
	tsCmd.Flags().StringVar(&tsgen.VarStringAPI, "openapi", "", "The api file")
	...
	validateCmd.Flags().StringVar(&validate.VarStringAPI, "openapi", "", "Validate target api file")
